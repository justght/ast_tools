...
const unicodeFix = require('../libs/common/unicodeOp')
const funcallFix = require('../libs/akamai/function_call')


function fix(source_code) {
    const ast = parser.parse(source_code)
    //字符修复
    traverse(ast,unicodeFix.fix)
    traverse(ast,funcallFix.fix)
